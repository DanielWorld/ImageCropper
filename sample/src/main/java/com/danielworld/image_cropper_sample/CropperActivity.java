...
import com.danielworld.imagecropper.util.ImageUtil;
import com.danielworld.image_cropper_sample.presenter.MainPresenter;
import com.danielworld.image_cropper_sample.presenterimpl.MainPresenterImpl;
...
//        iv.getCropImageThumbnail();
    ...
    public void setPicture() {
        if (iv != null) {
            ...
            try {
                if (path == null) {
                    Toast.makeText(CropperActivity.this, "Invalid File", Toast.LENGTH_SHORT).show();
                } else {
    ...
    public void showMessage(String message) {
        Toast.makeText(CropperActivity.this, message, Toast.LENGTH_SHORT).show();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1000) {
            ...
            if (uri == null) {
                Toast.makeText(CropperActivity.this, "uri null!", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            try {
                ...
                Logger.d("OKAY", "file exif degree : " + degree);
            } catch (Exception e) {
                e.printStackTrace();
            }
            ...
            for (int index = 0; index < grantResults.length; index++) {
                if (grantResults[index] != PackageManager.PERMISSION_GRANTED) {
                    if (!shouldShowRequestPermissionRationale(permissions[index])) {
                        Toast.makeText(CropperActivity.this, "Sorry, You gotta approve these permissions in Setting page", Toast.LENGTH_SHORT).show();
                        finish();
                        return;
                    }
                    else {
